...
If you use [`Seurat`](https://satijalab.org/seurat/) to process your data, cluster average expression can be retrieved with [`AverageExpression()`](https://satijalab.org/seurat/reference/averageexpression) [^preprocess-1].

[^preprocess-1]: Note that you need to set `return.seurat = TRUE` to get log-normalized average ([Also see](https://github.com/satijalab/seurat/issues/193)).
